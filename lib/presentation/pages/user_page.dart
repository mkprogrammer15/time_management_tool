          ...
          BlocBuilder<ColleaguesCubit, ColleaguesState>(
            builder: (context, state) {
              if (state is ColleaguesLoading) {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Urlaubstage genommen: ${colleague.takenVacations.toString()}',
                                    ),
                                    Text(
                                      'Urlaubstage verbleiben: ${colleague.totalVacations - colleague.takenVacations}',
                                    ),
                                  ],
                                ),
                              ),
                ...
                return Center(child: Text('Fehler beim Laden der Mitarbeiter'));
              } else {
